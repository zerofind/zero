...
//! - `profiles/cleanup_base.toml` - Cross-platform categories
//! - `profiles/cleanup_macos.toml` - macOS-specific categories
//!
...
//!
//! ```ignore
//! use cleanup::{execute_full_cleanup_scan, execute_group_cleanup};
