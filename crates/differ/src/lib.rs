...
pub use compare::{
    ComputedHash, DiffOptions, DiffProgress, HashSender, diff, diff_with_atomic_progress,
    diff_with_options, diff_with_progress, diff_with_progress_and_hash_streaming,
    diff_with_progress_and_hashes,
};
