...
use sync::{SyncJob, SyncOptions, SyncResult};
...
impl Executor {
    ...
    pub(super) async fn run_automation(
        ...
        // Set up cancellation
        let (cancel_tx, cancel_rx) = crossfire::mpsc::bounded_async::<()>(1);
    ...
    pub(super) async fn execute_sync(
        ...
        mut cancel_rx: crossfire::AsyncRx<crossfire::mpsc::Array<()>>,
    ...
    async fn sync_single_path(
        ...
        settings: &Settings,
        _cancel_rx: &mut crossfire::AsyncRx<crossfire::mpsc::Array<()>>,
