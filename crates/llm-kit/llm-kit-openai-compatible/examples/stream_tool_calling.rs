...
/// Streaming tool calling example using OpenAI-compatible provider with only llm-kit-provider.
///
...
/// cargo run --example stream_tool_calling -p llm-kit-openai-compatible
/// ```
