...
use super::*;
use crate::cache::automations::{NewAutomation, PathMapping, Settings, Triggers};
use crate::cache::runs::TriggerType;
use crate::cache::storages::DeviceInfo;
...
fn run_lifecycle() {
    ...
    assert_eq!(r.status, crate::cache::runs::RunStatus::Running);
