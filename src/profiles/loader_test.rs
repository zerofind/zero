...
#[test]
fn test_os_profile_filename() {
    assert_eq!(Os::MacOs.profile_filename(), "macos.toml");
    assert_eq!(Os::Linux.profile_filename(), "linux.toml");
    assert_eq!(Os::Windows.profile_filename(), "windows.toml");
}
